Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/KnowChat/KCSecurityUtil/tree/1.0.0" # 仓库的主页
  s.source       = { :git => "https://github.com/KnowChat/KCSecurityUtil.git", :tag => "#{s.version}" }#你的仓库地址，不能用SSH地址
  s.source_files = "SecurityUtil/*.{h,m}" # 你代码的位置， BYPhoneNumTF/*.{h,m} 表示 BYPhoneNumTF 文件夹下所有的.h和.m文件
